...
function RenderClassifAIEditorHeaderPluginArea() {
	...
	const popoverStyles = {
		...
		top: 'calc(100% + 4px)',
		right: 'calc(100% - 20px)',
		boxShadow: '0 4px 5px #0000000a,0 12px 12px #00000008,0 16px 16px #00000005',
		borderRadius: '4px',
		transform: 'scale(1)',
	...
	return (
		<SlotFillProvider>
			...
			<div className="classifai-editor-header-setting-custom-popover" style={ popoverStyles }>
