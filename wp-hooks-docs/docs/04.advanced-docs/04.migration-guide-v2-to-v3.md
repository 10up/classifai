---
id: migration-guide-v2-to-v3
title: "Migration guide (version 2 to version 3)"
sidebar_label: "Migration guide (version 2 to version 3)"
---
...
To learn more about how to add new Features or Providers to ClassifAI as a third-party developer, please refer to the [Useful snippets](../03.advanced-docs/01.useful-snippets.md) guide that contains code examples for both.
...
| --- | --- |
| **`classifai_allowed_roles`** | [`classifai_{feature}_roles`](../hooks/Filters/classifai_.staticID._roles.md) |
| **`classifai_chatgpt_allowed_roles`** | [`classifai_{feature}_roles`](../hooks/Filters/classifai_.staticID._roles.md) |
| **`classifai_openai_dalle_allowed_image_roles`** | [`classifai_{feature}_roles`](../hooks/Filters/classifai_.staticID._roles.md) |
| **`classifai_has_access`** | [`classifai_{$feature}_has_access`](../hooks/Filters/classifai_.staticID._has_access.md) |
| **`classifai_is_{$feature}_enabled`** | [`classifai_{$feature}_is_enabled`](../hooks/Filters/classifai_.staticID._is_enabled.md) |
| **`classifai_openai_dalle_enable_image_gen`** | [`classifai_{$feature}_is_feature_enabled`](../hooks/Filters/classifai_.staticID._is_feature_enabled.md) |
| **`classifai_openai_embeddings_post_statuses`** | [`classifai_{feature}_post_statuses`](../hooks/Filters/classifai_.staticID._post_statuses.md) |
| **`classifai_post_statuses`** | [`classifai_{feature}_post_statuses`](../hooks/Filters/classifai_.staticID._post_statuses.md) |
| **`classifai_post_types`** | [`classifai_{feature}_post_types`](../hooks/Filters/classifai_.staticID._post_types.md) |
| **`classifai_{$this->option_name}_enable_{$feature}`** | [`classifai_{$feature}_is_feature_enabled`](../hooks/Filters/classifai_.staticID._is_feature_enabled.md) |
| **`classifai_taxonomy_for_feature`** | [`classifai_feature_classification_taxonomy_for_feature`](../hooks/Filters/classifai_feature_classification_taxonomy_for_feature.md) |
...
Aside from these hook changes, ClassifAI 3.0.0 introduces many new actions and filters, which you can find [here](../hooks/index.md)
