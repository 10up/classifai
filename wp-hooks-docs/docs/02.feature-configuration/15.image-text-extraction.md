...
title: "Feature Configuration - Image Text Extraction"
sidebar_label: "Image Text Extraction"
---
...
### 2. Configure Microsoft Azure API and Key under Tools > ClassifAI > Image Processing > Image Text Extraction > Settings
...
* OCS will automatically detect text in images (e.g., handwritten notes) and saves that as content with the image.
