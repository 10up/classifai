...
title: "Feature Configuration - Content Generation"
...
### 2. Configure OpenAI API Keys under Tools > ClassifAI > Language Processing > Content Generation > Settings

* Select **OpenAI ChatGPT** in the provider dropdown.
* Enter your API Key copied from the above step into the `API Key` field.

### 3. Enable Content Generation
...
* A sparkle icon will show in the bottom right corner in the block editor. Click on this to start the generation process.
