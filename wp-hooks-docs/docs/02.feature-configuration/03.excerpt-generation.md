...
title: "Feature Configuration - Excerpt Generation"
sidebar_label: "Excerpt Generation"
---
...
### 2. Configure OpenAI API Keys under Tools > ClassifAI > Language Processing > Excerpt Generation > Settings

* Select **OpenAI ChatGPT** in the provider dropdown.
* Enter your API Key copied from the above step into the `API Key` field.

### 3. Enable Excerpt Generation
...
* Edit (or create) an item that supports excerpts.
