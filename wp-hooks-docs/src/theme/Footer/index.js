...
function GetStartedSection() {
	...
	const isHome = location.pathname === '/classifai/';
	return (
		<section
			className={ clsx(
				styles.getStartedSection,
				! isHome ? styles.greySection : ''
			) }
		>
			<div className="container">
				<h2 className={ styles.sectionTitle }>Ready to Get Started?</h2>
				<p className={ styles.sectionDescription }>
					ClassifAI is a Free WordPress plugin that connects to your
					choice of AI platforms.
				</p>
				<div className={ styles.getStartedActions }>
					<Link
						className="button button--primary button--lg"
						to="https://classifaiplugin.com/#cta"
					>
						Download ClassifAI Plugin
					</Link>
				</div>
			</div>
		</section>
					...
					<div className={ styles.footerContainer }>
						<div className={ styles.footerCopyright }>
							<div className={ styles.footerCopyrightLinks }>
								...
								/>
								<a href="https://github.com/10up/classifai/issues/">
									Support
								</a>
								&nbsp;
								<span>&nbsp;|&nbsp;</span>
								<a href="https://github.com/10up/classifai/">
									Contribute
								</a>
								&nbsp;
								<span>&nbsp;|&nbsp;</span>
								<a href="https://classifaiplugin.com/privacy-policy/">
									Privacy Policy
								</a>
							</div>
						</div>
						<div className={ styles.footerLogo }>
							<img
								...
								width="172"
								height="33"
								src="https://classifaiplugin.com/wp-content/uploads/sites/3/2025/06/lockup_white.svg"
								alt="Fueled Logo"
							/>
								...
								<div className={ styles.footer10upButtonInner }>
									...
									>
										...
										<img
											...
											height="24"
											style={ { width: '21px' } }
											src="https://classifaiplugin.com/wp-content/uploads/sites/3/2025/06/svgexport-3-1.svg"
											alt="10up Logo"
										/>{ ' ' }
										WordPress Practice
									</a>
						...
						<div className={ styles.footerSocial }>
							<a
								href="https://www.facebook.com/10up.agency/?ref=classifai"
