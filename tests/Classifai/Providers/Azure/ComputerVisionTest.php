...
class ComputerVisionTest extends WP_UnitTestCase {
	...
	public function test_get_largest_acceptable_image_url() {
		...
		$this->assertEquals( 'http://example.org/wp-content/uploads/2019/07/33772-1024x576.jpg', $url );
		...
		$this->assertEquals( 'http://example.org/wp-content/uploads/2019/07/2004-07-22-DSC_0008.jpg', $url );
