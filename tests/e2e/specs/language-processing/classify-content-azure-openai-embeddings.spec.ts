...
test.describe( '[Language processing] Classify Content (Azure OpenAI) Tests', () => {
	test.beforeAll( async ( { browser, requestUtils } ) => {
		...
		await page
			...
			.selectOption( 'azure_openai_embeddings' );
		// Save settings.
	...
	test( 'Can save Azure OpenAI Embeddings "Language Processing" settings', async ( {
		classifaiUtils,
		page,
	} ) => {
