...
test.describe( '[Language Processing] Text to Speech (Amazon Polly) Tests', () => {
	test.beforeAll( async ( { browser, requestUtils } ) => {
		...
		await page
			...
			.selectOption( 'aws_polly' );

		await page.locator( '#aws_polly_access_key_id' ).fill( '' );
		await page
			.locator( '#aws_polly_access_key_id' )
			.fill( 'SAMPLE_ACCESS_KEY' );
		await page.locator( '#aws_polly_secret_access_key' ).fill( '' );
		await page
			.locator( '#aws_polly_secret_access_key' )
			.fill( 'SAMPLE_SECRET_ACCESS_KEY' );
		await page.locator( '#aws_polly_aws_region' ).fill( '' );
		await page
			.locator( '#aws_polly_aws_region' )
			.fill( 'SAMPLE_SECRET_ACCESS_KEY' );
		...
		await page.locator( '#aws_polly_voice' ).selectOption( 'Aditi' );
