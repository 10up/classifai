describe( 'Image Generation (Google AI) Tests', () => {
	before( () => {
		cy.login();
	...
	it( 'Can save settings', () => {
		...
		cy.get( 'select#googleai_images_number_of_images' ).select( '2' );
		cy.get( 'select#googleai_images_aspect_ratio' ).select( '16:9' );
