...
1. Features + Platforms: If there is a new feature, new platform, or new intersection of the two then ensure that's added to the [Choose Your AI Platforms page](https://classifaiplugin.com/choose-your-platforms/).
