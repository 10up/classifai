...
/**
 * Abstract Base Class for Klasifai Taxonomies. A Taxonomy should
...
abstract class AbstractTaxonomy {
	...
	public function get_labels() {
		...
		$labels = array(
			...
			'search_items'               => sprintf( __( 'Search %s', 'klasifai' ), $plural_label ),
			'popular_items'              => sprintf( __( 'Popular %s', 'klasifai' ), $plural_label ),
			'all_items'                  => sprintf( __( 'All %s', 'klasifai' ), $plural_label ),
			'edit_item'                  => sprintf( __( 'Edit %s', 'klasifai' ), $singular_label ),
			'update_item'                => sprintf( __( 'Update %s', 'klasifai' ), $singular_label ),
			'add_new_item'               => sprintf( __( 'Add New %s', 'klasifai' ), $singular_label ),
			'new_item_name'              => sprintf( __( 'New %s Name', 'klasifai' ), $singular_label ),
			'separate_items_with_commas' => sprintf( __( 'Separate %s with commas', 'klasifai' ), strtolower( $plural_label ) ),
			'add_or_remove_items'        => sprintf( __( 'Add or remove %s', 'klasifai' ), strtolower( $plural_label ) ),
			'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s', 'klasifai' ), strtolower( $plural_label ) ),
			'not_found'                  => sprintf( __( 'No %s found.', 'klasifai' ), strtolower( $plural_label ) ),
			'not_found_in_trash'         => sprintf( __( 'No %s found in Trash.', 'klasifai' ), strtolower( $plural_label ) ),
		);
	...
	public function get_feature_enabled( $feature ) {
		$settings = get_option( 'klasifai_settings' );
