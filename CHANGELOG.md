...
- Support for WooCommerce product-based title and excerpt generation (props [@faisal-alvi](https://github.com/faisal-alvi), [@dkotter](https://github.com/dkotter), [@jeffpaul](https://github.com/jeffpaul) via [#871](https://github.com/10up/classifai/pull/871)).
...
- Bump WordPress minimum from 6.6 to 6.7 (props [@faisal-alvi](https://github.com/faisal-alvi), [@dkotter](https://github.com/dkotter), [@jeffpaul](https://github.com/jeffpaul) via [#871](https://github.com/10up/classifai/pull/871)).
