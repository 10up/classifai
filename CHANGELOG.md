...
- For the TTS generation process, added a new display option to control the display of the audio controls on the front-end (props [@joshuaabenazer](https://github.com/joshuaabenazer), [@dkotter](https://github.com/dkotter) via [#549](https://github.com/10up/classifai/pull/549)).
