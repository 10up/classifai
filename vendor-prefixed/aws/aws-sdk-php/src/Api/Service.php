...
namespace ClassifaiVendor\Aws\Api;
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = ['json' => \ClassifaiVendor\Aws\Api\Serializer\JsonRpcSerializer::class, 'query' => \ClassifaiVendor\Aws\Api\Serializer\QuerySerializer::class, 'rest-json' => \ClassifaiVendor\Aws\Api\Serializer\RestJsonSerializer::class, 'rest-xml' => \ClassifaiVendor\Aws\Api\Serializer\RestXmlSerializer::class];
    ...
    {
        static $mapping = ['json' => \ClassifaiVendor\Aws\Api\ErrorParser\JsonRpcErrorParser::class, 'query' => \ClassifaiVendor\Aws\Api\ErrorParser\XmlErrorParser::class, 'rest-json' => \ClassifaiVendor\Aws\Api\ErrorParser\RestJsonErrorParser::class, 'rest-xml' => \ClassifaiVendor\Aws\Api\ErrorParser\XmlErrorParser::class, 'ec2' => \ClassifaiVendor\Aws\Api\ErrorParser\XmlErrorParser::class];
    ...
    {
        static $mapping = ['json' => \ClassifaiVendor\Aws\Api\Parser\JsonRpcParser::class, 'query' => \ClassifaiVendor\Aws\Api\Parser\QueryParser::class, 'rest-json' => \ClassifaiVendor\Aws\Api\Parser\RestJsonParser::class, 'rest-xml' => \ClassifaiVendor\Aws\Api\Parser\RestXmlParser::class];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
