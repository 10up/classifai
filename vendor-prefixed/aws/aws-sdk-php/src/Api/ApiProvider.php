...
use ClassifaiVendor\Aws\Exception\UnresolvedApiException;
 ...
 *
 *     $c = \ClassifaiVendor\Aws\or_chain($a, $b);
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \ClassifaiVendor\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \ClassifaiVendor\Aws\load_compiled_json($path);
