...
use ClassifaiVendor\Aws\Api\MapShape;
use ClassifaiVendor\Aws\Api\Service;
use ClassifaiVendor\Aws\Api\Operation;
use ClassifaiVendor\Aws\Api\Shape;
use ClassifaiVendor\Aws\Api\StructureShape;
use ClassifaiVendor\Aws\Api\TimestampShape;
use ClassifaiVendor\Aws\CommandInterface;
use ClassifaiVendor\Aws\EndpointV2\EndpointV2SerializerTrait;
use ClassifaiVendor\Aws\EndpointV2\Ruleset\RulesetEndpoint;
use ClassifaiVendor\GuzzleHttp\Psr7;
use ClassifaiVendor\GuzzleHttp\Psr7\Request;
use ClassifaiVendor\GuzzleHttp\Psr7\Uri;
use ClassifaiVendor\GuzzleHttp\Psr7\UriResolver;
