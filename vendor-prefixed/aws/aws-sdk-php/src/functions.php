 ...
 *     $fn = \ClassifaiVendor\Aws\or_chain($a, $b);
 *     echo $fn(1, 2); // 3
 *
 * @return callable
 */
...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \ClassifaiVendor\Aws\Handler\GuzzleV6\GuzzleHandler();
    }

    // If Guzzle 5 installed
    if ($version === 5) {
        return new \ClassifaiVendor\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \ClassifaiVendor\GuzzleHttp\default_user_agent();
    }

    // If Guzzle 5 installed
    if ($version === 5) {
        return \ClassifaiVendor\GuzzleHttp\Client::getDefaultUserAgent();
    }
...
function guzzle_major_version()
{
    ...
    if (defined('\ClassifaiVendor\GuzzleHttp\ClientInterface::VERSION')) {
    ...
    } elseif (defined('\ClassifaiVendor\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
