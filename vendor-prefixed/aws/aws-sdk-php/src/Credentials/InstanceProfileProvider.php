...
use ClassifaiVendor\Aws\Exception\InvalidJsonException;
use ClassifaiVendor\Aws\Sdk;
use ClassifaiVendor\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \ClassifaiVendor\Aws\default_http_handler();
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \ClassifaiVendor\Aws\default_user_agent();
    ...
    {
        $isImdsV1Disabled = \ClassifaiVendor\Aws\boolean_value($this->ec2MetadataV1Disabled)
            ?? \ClassifaiVendor\Aws\boolean_value(
