...
use ClassifaiVendor\AWS\CRT\Auth\Signable;
use ClassifaiVendor\AWS\CRT\Auth\SignatureType;
use ClassifaiVendor\AWS\CRT\Auth\SignedBodyHeaderType;
use ClassifaiVendor\AWS\CRT\Auth\Signing;
use ClassifaiVendor\AWS\CRT\Auth\SigningAlgorithm;
use ClassifaiVendor\AWS\CRT\Auth\SigningConfigAWS;
use ClassifaiVendor\AWS\CRT\Auth\StaticCredentialsProvider;
use ClassifaiVendor\AWS\CRT\HTTP\Request;
use ClassifaiVendor\Aws\Exception\CommonRuntimeException;
use ClassifaiVendor\Aws\Exception\CouldNotCreateChecksumException;
