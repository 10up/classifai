...
use ClassifaiVendor\Aws\S3\Exception\DeleteMultipleObjectsException;
 ...
 * operation.
 *
 *     $s3 = new \ClassifaiVendor\Aws\S3\Client([
 *         'region' => 'us-west-2',
 *         'version' => 'latest'
 *     ]);
 *
 *     $listObjectsParams = ['Bucket' => 'foo', 'Prefix' => 'starts/with/'];
 *     $delete = ClassifaiVendor\Aws\S3\BatchDelete::fromListObjects($s3, $listObjectsParams);
