...
use ClassifaiVendor\Aws\Multipart\AbstractUploader;
use ClassifaiVendor\Aws\PhpHash;
use ClassifaiVendor\Aws\ResultInterface;
use ClassifaiVendor\GuzzleHttp\Psr7;
use ClassifaiVendor\Psr\Http\Message\StreamInterface as Stream;
use ClassifaiVendor\Aws\S3\Exception\S3MultipartUploadException;
