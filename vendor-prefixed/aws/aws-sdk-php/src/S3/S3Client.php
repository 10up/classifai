...
use ClassifaiVendor\Aws\HandlerList;
use ClassifaiVendor\Aws\Identity\S3\S3ExpressIdentityProvider;
use ClassifaiVendor\Aws\InputValidationMiddleware;
use ClassifaiVendor\Aws\Middleware;
use ClassifaiVendor\Aws\ResultInterface;
use ClassifaiVendor\Aws\Retry\QuotaManager;
use ClassifaiVendor\Aws\RetryMiddleware;
use ClassifaiVendor\Aws\RetryMiddlewareV2;
use ClassifaiVendor\Aws\S3\Parser\GetBucketLocationResultMutator;
use ClassifaiVendor\Aws\S3\Parser\S3Parser;
use ClassifaiVendor\Aws\S3\Parser\ValidateResponseChecksumResultMutator;
use ClassifaiVendor\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use ClassifaiVendor\Aws\S3\UseArnRegion\Configuration;
use ClassifaiVendor\Aws\S3\UseArnRegion\ConfigurationInterface;
use ClassifaiVendor\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
...
class S3Client extends AwsClient implements S3ClientInterface
{
     ...
     *   (ClassifaiVendor\Aws\S3\RegionalEndpoint\ConfigurationInterface|ClassifaiVendor\Aws\CacheInterface\|callable|string|array)
     ...
     * - use_arn_region: (ClassifaiVendor\Aws\S3\UseArnRegion\ConfigurationInterface,
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \ClassifaiVendor\Aws\serialize($command);
        ...
        /** @var \ClassifaiVendor\Aws\Signature\SignatureInterface $signer */
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \ClassifaiVendor\Aws\serialize($command)->getUri();
    }
    ...
    {
        if ($value) {
            $config = \ClassifaiVendor\Aws\Retry\ConfigurationProvider::unwrap($value);
