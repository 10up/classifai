<?php
namespace ClassifaiVendor\Aws\S3\RegionalEndpoint;
...
use ClassifaiVendor\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \ClassifaiVendor\Aws\parse_ini_file($filename, true);
            if ($data === false) {
