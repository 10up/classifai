...
use ClassifaiVendor\Aws\AwsClientInterface;
...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     *
     * @see \ClassifaiVendor\Aws\S3\S3Client::listObjects
     ...
     *
     * @see \ClassifaiVendor\Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see \ClassifaiVendor\Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     *
     * @see \ClassifaiVendor\Aws\S3\Transfer for more options and customization
     */
