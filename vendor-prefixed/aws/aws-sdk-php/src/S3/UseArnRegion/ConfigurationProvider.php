<?php
namespace ClassifaiVendor\Aws\S3\UseArnRegion;

use ClassifaiVendor\Aws\AbstractConfigurationProvider;
use ClassifaiVendor\Aws\CacheInterface;
use ClassifaiVendor\Aws\ConfigurationProviderInterface;
use ClassifaiVendor\Aws\S3\UseArnRegion\Exception\ConfigurationException;
 ...
 *
 * <code>
 * use ClassifaiVendor\Aws\S3\UseArnRegion\ConfigurationProvider;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \ClassifaiVendor\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
