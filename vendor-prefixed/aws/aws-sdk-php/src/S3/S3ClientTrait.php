...
use ClassifaiVendor\Aws\Api\Parser\PayloadParserTrait;
...
use ClassifaiVendor\GuzzleHttp\Promise\RejectedPromise;
...
trait S3ClientTrait
{
    ...
    public function deleteMatchingObjectsAsync(
        ...
        if ($regex) {
            $iter = \ClassifaiVendor\Aws\filter($iter, function ($c) use ($regex) {
