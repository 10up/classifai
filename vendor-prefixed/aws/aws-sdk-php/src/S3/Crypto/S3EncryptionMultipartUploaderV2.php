...
use ClassifaiVendor\Aws\S3\MultipartUploader;
use ClassifaiVendor\Aws\S3\S3ClientInterface;
...
class S3EncryptionMultipartUploaderV2 extends MultipartUploader
{
     ...
     *   function signature like `function (ClassifaiVendor\Aws\Command $command) {...}`.
     * - before_initiate: (callable) Callback to invoke before the
     *   `CreateMultipartUpload` operation. The callback should have a function
     *   signature like `function (ClassifaiVendor\Aws\Command $command) {...}`.
     * - before_upload: (callable) Callback to invoke before any `UploadPart`
     *   operations. The callback should have a function signature like
     *   `function (ClassifaiVendor\Aws\Command $command) {...}`.
     ...
     * - state: (ClassifaiVendor\Aws\Multipart\UploadState) An object that represents the state
