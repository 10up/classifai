<?php
namespace ClassifaiVendor\Aws\S3\Crypto;

use ClassifaiVendor\Aws\Crypto\DecryptionTraitV2;
use ClassifaiVendor\Aws\Exception\CryptoException;
use ClassifaiVendor\Aws\HashingStream;
use ClassifaiVendor\Aws\MetricsBuilder;
use ClassifaiVendor\Aws\PhpHash;
use ClassifaiVendor\Aws\Crypto\AbstractCryptoClientV2;
use ClassifaiVendor\Aws\Crypto\EncryptionTraitV2;
use ClassifaiVendor\Aws\Crypto\MetadataEnvelope;
use ClassifaiVendor\Aws\Crypto\MaterialsProvider;
use ClassifaiVendor\Aws\Crypto\Cipher\CipherBuilderTrait;
use ClassifaiVendor\Aws\S3\S3Client;
 ...
 *
 * <code>
 * use ClassifaiVendor\Aws\Crypto\KmsMaterialsProviderV2;
 * use ClassifaiVendor\Aws\S3\Crypto\S3EncryptionClientV2;
 * use ClassifaiVendor\Aws\S3\S3Client;
 *
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
     ...
     *   determined.
     *
     * @return \ClassifaiVendor\Aws\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *   materials providers. Defaults to false.
     *
     * @return \ClassifaiVendor\Aws\Result GetObject call result with the 'Body' field
