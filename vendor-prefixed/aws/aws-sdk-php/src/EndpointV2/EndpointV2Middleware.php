<?php
namespace ClassifaiVendor\Aws\EndpointV2;

use ClassifaiVendor\Aws\Api\Operation;
use ClassifaiVendor\Aws\Api\Service;
use ClassifaiVendor\Aws\Auth\Exception\UnresolvedAuthSchemeException;
...
use function ClassifaiVendor\JmesPath\search;
