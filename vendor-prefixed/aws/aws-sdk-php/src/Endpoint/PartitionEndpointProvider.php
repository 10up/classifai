<?php
namespace ClassifaiVendor\Aws\Endpoint;

use ClassifaiVendor\JmesPath\Env;
...
class PartitionEndpointProvider
{
    ...
    {
        $data = \ClassifaiVendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \ClassifaiVendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
