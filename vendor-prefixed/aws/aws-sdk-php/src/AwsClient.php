...
use ClassifaiVendor\Aws\Auth\AuthSelectionMiddleware;
use ClassifaiVendor\Aws\Auth\AuthSchemeResolverInterface;
use ClassifaiVendor\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use ClassifaiVendor\Aws\EndpointV2\EndpointProviderV2;
use ClassifaiVendor\Aws\EndpointV2\EndpointV2Middleware;
...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (ClassifaiVendor\Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     ...
     * - token:
     *   (ClassifaiVendor\Aws\Token\TokenInterface|array|bool|callable) Specifies
     ...
     * - csm:
     *   (ClassifaiVendor\Aws\ClientSideMonitoring\ConfigurationInterface|array|callable) Specifies
     *   the credentials used to sign requests. Provide an
     ...
     *   of S3).
     * - endpoint_discovery: (ClassifaiVendor\Aws\EndpointDiscovery\ConfigurationInterface,
     ...
     *   available regions.
     * - retries: (int, ClassifaiVendor\Aws\Retry\ConfigurationInterface, ClassifaiVendor\Aws\CacheInterface,
    ...
    private function parseClass()
    {
        ...
        return [
            strtolower($service),
            "ClassifaiVendor\\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \ClassifaiVendor\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \ClassifaiVendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
