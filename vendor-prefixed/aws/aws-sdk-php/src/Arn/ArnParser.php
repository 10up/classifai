<?php
namespace ClassifaiVendor\Aws\Arn;

use ClassifaiVendor\Aws\Arn\S3\AccessPointArn as S3AccessPointArn;
use ClassifaiVendor\Aws\Arn\ObjectLambdaAccessPointArn;
use ClassifaiVendor\Aws\Arn\S3\MultiRegionAccessPointArn;
use ClassifaiVendor\Aws\Arn\S3\OutpostsBucketArn;
use ClassifaiVendor\Aws\Arn\S3\RegionalBucketArn;
