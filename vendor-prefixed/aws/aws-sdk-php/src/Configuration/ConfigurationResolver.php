...
namespace ClassifaiVendor\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool'
            && !is_null($convertedValue = \ClassifaiVendor\Aws\boolean_value($value))
        ) {
    ...
    private static function retrieveValueFromIniSubsection(
        ...
        $services_section = \ClassifaiVendor\Aws\parse_ini_section_with_subsections(
            $filename,
