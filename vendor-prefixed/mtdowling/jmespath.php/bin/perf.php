...
// Warm up the runner
\ClassifaiVendor\JmesPath\Env::search('foo', []);
...
{
    $best = 99999;
    $runtime = \ClassifaiVendor\JmesPath\Env::createRuntime();
    ...
    for ($i = 0; $i < 100; $i++) {
        ...
        if (!getenv('CACHE')) {
            ...
            if ($runtime instanceof \ClassifaiVendor\JmesPath\CompilerRuntime) {
