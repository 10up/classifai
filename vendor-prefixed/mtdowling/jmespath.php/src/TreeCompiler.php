<?php
namespace ClassifaiVendor\JmesPath;
...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use ClassifaiVendor\\JmesPath\\TreeInterpreter as Ti;')
            ->write('use ClassifaiVendor\\JmesPath\\FnDispatcher as Fd;')
            ->write('use ClassifaiVendor\\JmesPath\\Utils;')
            ->write('')
