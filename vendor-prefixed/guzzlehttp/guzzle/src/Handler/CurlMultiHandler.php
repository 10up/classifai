...
use ClassifaiVendor\GuzzleHttp\Promise\Promise;
...
class CurlMultiHandler
{
    ...
    public function __construct(array $options = [])
    {
        ...
        if (isset($options['select_timeout'])) {
            ...
            classifaivendor_trigger_deprecation('guzzlehttp/guzzle', '7.2', 'The GUZZLE_CURL_SELECT_TIMEOUT environment variable is deprecated; use the "select_timeout" option instead.');
    ...
    {
        if (!is_int($id)) {
            classifaivendor_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing an int to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
