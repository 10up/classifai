...
use ClassifaiVendor\GuzzleHttp\Exception\BadResponseException;
use ClassifaiVendor\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    public function checkRedirect(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        if (\ClassifaiVendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $nextRequest->getUri()) && defined('\CURLOPT_HTTPAUTH')) {
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response): RequestInterface
    {
        ...
        $modify['uri'] = $uri;
        \ClassifaiVendor\GuzzleHttp\Psr7\Message::rewindBody($request);
        ...
        if (\ClassifaiVendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $modify['uri'])) {
            $modify['remove_headers'][] = 'Authorization';
            $modify['remove_headers'][] = 'Cookie';
        }
        return \ClassifaiVendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $modify);
    }
    /**
    ...
    {
        $location = \ClassifaiVendor\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new Psr7\Uri($response->getHeaderLine('Location')));
