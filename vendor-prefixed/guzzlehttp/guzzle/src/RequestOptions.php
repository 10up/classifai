...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\ClassifaiVendor\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\Stringable)
    ...
    /**
     * cookies: (false|ClassifaiVendor\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\ClassifaiVendor\Psr\Http\Message\StreamInterface) Where the data
